...
class TransItemToken(MetaToken):
    ...
    class TransTermin(Termin):
        ...
        @staticmethod
        def _new2631(_arg1 : str, _arg2 : bool, _arg3 : 'Typs', _arg4 : 'TransportKind') -> 'TransTermin':
        ...
        @staticmethod
        def _new2634(_arg1 : str, _arg2 : bool, _arg3 : 'Typs', _arg4 : str) -> 'TransTermin':
            res = TransItemToken.TransTermin(_arg1, _arg2)
            res.typ = _arg3
            res.acronym = _arg4
            return res
        ...
        @staticmethod
        def _new2635(_arg1 : str, _arg2 : bool, _arg3 : 'Typs', _arg4 : 'MorphLang') -> 'TransTermin':
            res = TransItemToken.TransTermin(_arg1, _arg2)
            res.typ = _arg3
            res.lang = _arg4
            return res
        ...
        @staticmethod
        def _new2636(_arg1 : str, _arg2 : bool, _arg3 : 'Typs') -> 'TransTermin':
            res = TransItemToken.TransTermin(_arg1, _arg2)
            res.typ = _arg3
            return res
        
        @staticmethod
        def _new2638(_arg1 : str, _arg2 : bool, _arg3 : 'Typs', _arg4 : 'MorphLang', _arg5 : 'TransportKind') -> 'TransTermin':
            res = TransItemToken.TransTermin(_arg1, _arg2)
            res.typ = _arg3
            res.lang = _arg4
            res.kind = _arg5
    ...
    def try_parse_list(t : 'Token', max_count : int=10) -> typing.List['TransItemToken']:
        ...
        while True:
            ...
            if (tr0.typ == TransItemToken.Typs.NOUN or tr0.typ == TransItemToken.Typs.ORG): 
                if (t.is_hiphen0 and t.next0_ is not None): 
                    t = t.next0_
            ...
            if (tr is None): 
                if (tr0.typ == TransItemToken.Typs.NAME): 
                    if (t.is_char(',')): 
                        tr = TransItemToken.try_parse(t.next0_, tr0, True, False)
                    elif (t.morph.class0_.is_conjunction0 and t.is_and0): 
                        tr = TransItemToken.try_parse(t.next0_, tr0, True, False)
                        and_conj = True
                if (tr is not None): 
            ...
            if (t.is_comma_and0 and tr is None): 
        ...
        while i < (len(res) - 1): 
            if (res[i].typ == TransItemToken.Typs.MODEL and res[i + 1].typ == TransItemToken.Typs.MODEL): 
                ...
                res[i].value = "{0}{1}{2}".format(res[i].value, ('-' if res[i].end_token.next0_ is not None and res[i].end_token.next0_.is_hiphen0 else ' '), res[i + 1].value)
                del res[i + 1]
                i -= 1
            i += 1
    ...
    def __try_parse(t : 'Token', prev : 'TransItemToken', after_conj : bool, attach_high : bool=False) -> 'TransItemToken':
        ...
        if (isinstance(t1, ReferentToken)): 
            if (t1.get_referent().type_name == "ORGANIZATION"): 
                return TransItemToken._new2616(t, t1, TransItemToken.Typs.ORG, t1.get_referent(), t1.morph)
        if (t1 is not None and t1.is_value("ФЛАГ", None)): 
            ...
            if ((isinstance(tt, ReferentToken)) and (isinstance(tt.get_referent(), GeoReferent))): 
                return TransItemToken._new2617(t, tt, TransItemToken.Typs.GEO, tt.get_referent())
        ...
        if (t1 is not None and ((t1.is_value("СЛЕДОВАТЬ", "СЛІДУВАТИ") or t1.is_value("ВЫПОЛНЯТЬ", "ВИКОНУВАТИ")))): 
            t1 = t1.next0_
            route = True
        if (t1 is not None and t1.morph.class0_.is_preposition0): 
            t1 = t1.next0_
        ...
        if (isinstance(t1, ReferentToken)): 
            if (isinstance(t1.get_referent(), GeoReferent)): 
                ...
                if (geo_.is_state0 or geo_.is_city0): 
                    tit = TransItemToken._new2619(t, t1, TransItemToken.Typs.ROUTE, list())
                    ...
                    while True:
                        ...
                        if (geo_ is None): 
                            break
                        if (not geo_.is_city0 and not geo_.is_state0): 
                            break
                        tit.route_items.append(geo_)
                        tit.end_token = t1
                ...
                tit = TransItemToken._new2617(t, t1, TransItemToken.Typs.DATE, t1.get_referent())
        ...
        if (isinstance(t, TextToken)): 
            ...
            if (tok is not None): 
                ...
                if (tt.canonic_text == "СУДНО"): 
                    if ((((tok.morph.number) & (MorphNumber.PLURAL))) != (MorphNumber.UNDEFINED)): 
                        if (not BracketHelper.can_be_start_of_sequence(tok.end_token.next0_, False, False)): 
                            return None
                tit = TransItemToken._new2621(tok.begin_token, tok.end_token, tt.kind, tt.typ, tt.is_doubt, tok.chars, tok.morph)
                ...
                return tit
            if (tok is None and t.morph.class0_.is_adjective0): 
                    ...
                    while True:
                        ...
                        if (tok is not None and tok.end_token == npt.end_token): 
                            if ((tok.termin).typ == TransItemToken.Typs.NOUN): 
                                tit = TransItemToken._new2621(t, tok.end_token, (tok.termin).kind, TransItemToken.Typs.NOUN, (tok.termin).is_doubt, tok.chars, npt.morph)
                                tit.value = (tok.termin).canonic_text.lower()
                                tit.alt_value = npt.get_normal_case_text(None, False, MorphGender.UNDEFINED, False).lower()
                                if (LanguageHelper.ends_with_ex(tit.alt_value, "суд", "суда", None, None)): 
                                    if (not BracketHelper.can_be_start_of_sequence(tok.end_token.next0_, False, False)): 
                                        continue
                                if (state_ is not None): 
                                    if ((state_.referent).is_state0): 
                                        tit.state = state_
                                return tit
        if (t is not None and t.is_value("КЛАСС", None) and t.next0_ is not None): 
            ...
            if (br is not None): 
                return TransItemToken._new2623(t, br.end_token, TransItemToken.Typs.CLASS, MiscHelper.get_text_value_of_meta_token(br, GetTextAttr.NO))
                    ...
                    for c in s: 
                        if (not Utils.isWhitespace(c)): 
                            if (str.isalpha(c)): 
                                ...
                                un += 1
                    if (((digs == 0 and un == 0 and t.next0_.chars.is_capital_upper0)) or prev.kind == TransportKind.SHIP or prev.kind == TransportKind.SPACE): 
                        return TransItemToken._new2623(br.begin_token, br.end_token, TransItemToken.Typs.NAME, s)
                    if (digs > 0 and (chars_ < 5)): 
                        return TransItemToken._new2623(br.begin_token, br.end_token, TransItemToken.Typs.MODEL, s.replace(" ", ""))
        if (prev is not None and (((prev.typ == TransItemToken.Typs.NOUN or prev.typ == TransItemToken.Typs.BRAND or prev.typ == TransItemToken.Typs.NAME) or prev.typ == TransItemToken.Typs.MODEL))): 
            ...
            if (tit is not None): 
                return tit
        if (((prev is not None and prev.typ == TransItemToken.Typs.NOUN and prev.kind == TransportKind.AUTO) and (isinstance(t, TextToken)) and t.chars.is_letter0) and not t.chars.is_all_lower0 and (t.whitespaces_before_count < 2)): 
            pt = t.kit.process_referent("PERSON", t)
            if (pt is None): 
                tit = TransItemToken._new2626(t, t, TransItemToken.Typs.BRAND)
                tit.value = (t).term
        ...
        if (((prev is not None and prev.typ == TransItemToken.Typs.NOUN and ((prev.kind == TransportKind.SHIP or prev.kind == TransportKind.SPACE)))) or after_conj): 
            if (t.chars.is_capital_upper0): 
                ...
                if (npt is not None and len(npt.adjectives) > 0): 
                    ...
                    if (rt is not None): 
                        ok = False
                if (t.get_morph_class_in_dictionary().is_proper_surname0): 
                ...
                if (ok): 
                    ...
                    if (s is not None): 
                        res1 = TransItemToken._new2627(t, t1, TransItemToken.Typs.NAME, True, s)
                        if (not t1.is_newline_after0): 
    ...
    def __attach_model(t : 'Token', can_be_first_word : bool, prev : 'TransItemToken') -> 'TransItemToken':
        res = TransItemToken._new2626(t, t, TransItemToken.Typs.MODEL)
        cyr = io.StringIO()
        lat = io.StringIO()
        t0 = t
        num = False
        ...
        while True:
            ...
            if (t != t0 and t.whitespaces_before_count > 1): 
                break
            if (t == t0): 
                if (t.is_hiphen0 or t.chars.is_all_lower0): 
            ...
            if (t != t0 and TransItemToken.try_parse(t, None, False, False) is not None): 
                break
            if (num and t.is_whitespace_before0): 
                break
            num = False
            vv = MiscHelper.get_cyr_lat_word(t, 3)
            if (vv is None): 
                if (can_be_first_word and t == t0): 
                    if (t.chars.is_letter0 and t.chars.is_capital_upper0): 
                        vv = MiscHelper.get_cyr_lat_word(t, 0)
                        if ((vv) is not None): 
                            if (t.morph.case_.is_genitive0 and ((prev is None or prev.typ != TransItemToken.Typs.BRAND))): 
                                vv = (None)
                ...
                if (vv is None): 
                    break
            if ((vv.length < 4) or t.morph.class0_.is_preposition0 or t.morph.class0_.is_conjunction0): 
                if (t.is_whitespace_before0 and t.is_whitespace_after0): 
                    if (t.previous is not None and not t.previous.is_hiphen0): 
    ...
    def _attach_number(t : 'Token', ignore_region : bool=False) -> 'TransItemToken':
        ...
        while True:
            ...
            nt = Utils.asObjectOrNull(t, NumberToken)
            if (nt is not None): 
                if (nt.typ != NumberSpellingType.DIGIT or nt.morph.class0_.is_adjective0): 
                    break
                if (res is None): 
                    res = io.StringIO()
            ...
            if (not tt.chars.is_letter0): 
                break
            if (not tt.chars.is_all_upper0 and tt.is_whitespace_before0): 
                break
            if (tt.length_char > 3): 
                break
            if (res is None): 
        ...
        if (res is None or (res.tell() < 4)): 
            return None
        re = TransItemToken._new2623(t0, t1, TransItemToken.Typs.NUMBER, Utils.toStringStringIO(res))
    ...
    def _attach_rus_auto_number(t : 'Token') -> 'TransItemToken':
        ...
        t0 = t
        doubt = 0
        if (not t.chars.is_all_upper0 or t.is_whitespace_after0): 
            doubt += 1
        t = t.next0_
        nt = Utils.asObjectOrNull(t, NumberToken)
        if ((nt is None or nt.typ != NumberSpellingType.DIGIT or nt.morph.class0_.is_adjective0) or (nt.end_char - nt.begin_char) != 2): 
            return None
        t = t.next0_
        ...
        if (not t.chars.is_all_upper0 or t.is_whitespace_after0): 
            doubt += 1
        res = TransItemToken._new2630(t0, t, TransItemToken.Typs.NUMBER, TransportKind.AUTO)
        res.value = "{0}{1}{2}".format(v1.cyr_word, nt.get_source_text(), v2.cyr_word)
        nt = (Utils.asObjectOrNull(t.next0_, NumberToken))
        if (((nt is not None and nt.int_value is not None and nt.typ == NumberSpellingType.DIGIT) and not nt.morph.class0_.is_adjective0 and (nt.int_value < 200)) and (t.whitespaces_after_count < 2)): 
            n = nt.value
            if (len(n) < 2): 
                n = ("0" + n)
            res.alt_value = n
    ...
    def initialize() -> None:
        ...
        t = TransItemToken.TransTermin._new2631("автомобиль", True, TransItemToken.Typs.NOUN, TransportKind.AUTO)
        t.add_abridge("а-м")
        ...
        for s in ["ВНЕДОРОЖНИК", "ПОЗАШЛЯХОВИК", "АВТОБУС", "МИКРОАВТОБУС", "ГРУЗОВИК", "МОТОЦИКЛ", "МОПЕД"]: 
            TransItemToken.M_ONTOLOGY.add(TransItemToken.TransTermin._new2631(s, True, TransItemToken.Typs.NOUN, TransportKind.AUTO))
        t = TransItemToken.TransTermin._new2631("", True, TransItemToken.Typs.NOUN, TransportKind.AUTO)
        t.add_abridge("а-м")
        TransItemToken.M_ONTOLOGY.add(t)
        t = TransItemToken.TransTermin._new2634("государственный номер", True, TransItemToken.Typs.NUMBER, "ИМО")
        t.add_abridge("г-н")
        t.add_abridge("н\\з")
        t.add_abridge("г\\н")
        ...
        TransItemToken.M_ONTOLOGY.add(t)
        t = TransItemToken.TransTermin._new2635("державний номер", True, TransItemToken.Typs.NUMBER, MorphLang.UA)
        t.add_variant("держномер", False)
        t.add_abridge("держ.номер")
        t.add_abridge("держ.ном.")
        TransItemToken.M_ONTOLOGY.add(t)
        t = TransItemToken.TransTermin._new2636("номер", True, TransItemToken.Typs.NUMBER)
        TransItemToken.M_ONTOLOGY.add(t)
        for s in ["КРУИЗНЫЙ ЛАЙНЕР", "ТЕПЛОХОД", "ПАРОХОД", "ЯХТА", "ЛОДКА", "КОРАБЛЬ", "СУДНО", "ПОДВОДНАЯ ЛОДКА", "АПК", "ШХУНА", "ПАРОМ", "КРЕЙСЕР", "АВИАНОСЕЦ", "ЭСМИНЕЦ", "ФРЕГАТ", "ЛИНКОР", "АТОМОХОД", "ЛЕДОКОЛ", "ПЛАВБАЗА", "ТАНКЕР", "СУПЕРТАНКЕР", "СУХОГРУЗ", "ТРАУЛЕР", "РЕФРИЖЕРАТОР"]: 
            t = TransItemToken.TransTermin._new2631(s, True, TransItemToken.Typs.NOUN, TransportKind.SHIP)
            TransItemToken.M_ONTOLOGY.add(t)
            if (s == "АПК"): 
                t.is_doubt = True
        for s in ["КРУЇЗНИЙ ЛАЙНЕР", "ПАРОПЛАВ", "ПАРОПЛАВ", "ЯХТА", "ЧОВЕН", "КОРАБЕЛЬ", "СУДНО", "ПІДВОДНИЙ ЧОВЕН", "АПК", "ШХУНА", "ПОРОМ", "КРЕЙСЕР", "АВІАНОСЕЦЬ", "ЕСМІНЕЦЬ", "ФРЕГАТ", "ЛІНКОР", "АТОМОХІД", "КРИГОЛАМ", "ПЛАВБАЗА", "ТАНКЕР", "СУПЕРТАНКЕР", "СУХОВАНТАЖ", "ТРАУЛЕР", "РЕФРИЖЕРАТОР"]: 
            t = TransItemToken.TransTermin._new2638(s, True, TransItemToken.Typs.NOUN, MorphLang.UA, TransportKind.SHIP)
            TransItemToken.M_ONTOLOGY.add(t)
            if (s == "АПК"): 
                t.is_doubt = True
        for s in ["САМОЛЕТ", "АВИАЛАЙНЕР", "ИСТРЕБИТЕЛЬ", "БОМБАРДИРОВЩИК", "ВЕРТОЛЕТ"]: 
            TransItemToken.M_ONTOLOGY.add(TransItemToken.TransTermin._new2631(s, True, TransItemToken.Typs.NOUN, TransportKind.FLY))
        for s in ["ЛІТАК", "АВІАЛАЙНЕР", "ВИНИЩУВАЧ", "БОМБАРДУВАЛЬНИК", "ВЕРТОЛІТ"]: 
            TransItemToken.M_ONTOLOGY.add(TransItemToken.TransTermin._new2638(s, True, TransItemToken.Typs.NOUN, MorphLang.UA, TransportKind.FLY))
        for s in ["КОСМИЧЕСКИЙ КОРАБЛЬ", "ЗВЕЗДОЛЕТ", "КОСМИЧЕСКАЯ СТАНЦИЯ", "РАКЕТА-НОСИТЕЛЬ"]: 
            TransItemToken.M_ONTOLOGY.add(TransItemToken.TransTermin._new2631(s, True, TransItemToken.Typs.NOUN, TransportKind.SPACE))
        for s in ["КОСМІЧНИЙ КОРАБЕЛЬ", "ЗОРЕЛІТ", "КОСМІЧНА СТАНЦІЯ", "РАКЕТА-НОСІЙ"]: 
            TransItemToken.M_ONTOLOGY.add(TransItemToken.TransTermin._new2638(s, True, TransItemToken.Typs.NOUN, MorphLang.UA, TransportKind.SPACE))
    ...
    @staticmethod
    def _new2616(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : 'Referent', _arg5 : 'MorphCollection') -> 'TransItemToken':
    ...
    @staticmethod
    def _new2617(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : 'Referent') -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.ref = _arg4
        return res
    ...
    @staticmethod
    def _new2619(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : typing.List[object]) -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new2621(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'TransportKind', _arg4 : 'Typs', _arg5 : bool, _arg6 : 'CharsInfo', _arg7 : 'MorphCollection') -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.kind = _arg3
        res.typ = _arg4
        res.is_doubt = _arg5
    ...
    @staticmethod
    def _new2623(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : str) -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new2626(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs') -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new2627(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : bool, _arg5 : str) -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.is_doubt = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new2630(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Typs', _arg4 : 'TransportKind') -> 'TransItemToken':
        res = TransItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.kind = _arg4
        return res