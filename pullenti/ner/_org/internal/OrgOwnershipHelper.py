    ...
    def can_be_higher(higher : 'OrganizationReferent', lower : 'OrganizationReferent', robust : bool=False) -> bool:
        ...
        if (hk != OrganizationKind.DEPARTMENT): 
            ...
            if (not OrgOwnershipHelper.__contains(ltyps, "управление", "управління") and not OrgOwnershipHelper.__contains(ltyps, "департамент", None) and lk == OrganizationKind.DEPARTMENT): 
                return True
            if (((OrgOwnershipHelper.__contains(htyps, "главное", "головне") and OrgOwnershipHelper.__contains(htyps, "управление", "управління") and OrgOwnershipHelper.__contains(ltyps, "управление", "управління")) and not "главное управление" in ltyps and not "головне управління" in ltyps) and not "пограничное управление" in ltyps): 
                return True
