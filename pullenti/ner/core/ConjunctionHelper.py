    ...
    def try_parse(t : 'Token') -> 'ConjunctionToken':
        ...
        if (t.is_comma): 
            ...
            if (ne is not None): 
                ...
                ne.is_simple = False
                return ne
            return ConjunctionToken._new549(t, t, ConjunctionType.COMMA, True, ",")
        ...
        if (t.is_and or t.is_or): 
            res = ConjunctionToken._new551(t, t, (t).term, True, (ConjunctionType.OR if t.is_or else ConjunctionType.AND))
