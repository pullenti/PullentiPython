...
class UnitsHelper:
    ...
    def initialize() -> None:
        ...
        u = Unit._new1709("м", "m", "метр", "meter", MeasureKind.LENGTH)
        ...
        uu = Unit._new1709("миль", "mile", "морская миля", "mile", MeasureKind.LENGTH)
        uu.base_unit = u
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("фут", "ft", "фут", "foot", u, 0.304799472, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new119("ФУТ", uu)
        t.add_abridge("FT.")
        t.add_variant("FOOT", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("дюйм", "in", "дюйм", "inch", u, 0.0254, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new119("ДЮЙМ", uu)
        t.add_abridge("IN")
        t.add_variant("INCH", False)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1709("ар", "are", "ар", "are", MeasureKind.AREA)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1709("га", "ga", "гектар", "hectare", MeasureKind.AREA)
        uu.base_unit = u
        ...
        t.add_abridge("GA")
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1709("г", "g", "грамм", "gram", MeasureKind.WEIGHT)
        ...
        uu = Unit._new1713("ц", "centner", "центнер", "centner", u, 100000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("Ц.")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("т", "t", "тонна", "tonne", u, 1000000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        u = Unit._new1709("л", "l", "литр", "liter", MeasureKind.VOLUME)
        ...
        uu = Unit._new1713("галлон", "gallon", "галлон", "gallon", u, 4.5461, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("ГАЛ")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("баррель", "bbls", "баррель нефти", "barrel", u, 158.987, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1709("сек", "sec", "секунда", "second", MeasureKind.TIME)
        UnitsHelper.USEC = u
        ...
        uu = Unit._new1709("мин", "min", "минута", "minute", MeasureKind.TIME)
        ...
        UnitsHelper.TERMINS.add(t)
        u = uu
        uu = Unit._new1713("ч", "h", "час", "hour", u, 60, MeasureKind.TIME)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1709("дн", "d", "день", "day", MeasureKind.TIME)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1709("сут", "d", "сутки", "day", MeasureKind.TIME)
        ...
        t.add_variant("DAY", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("нед", "week", "неделя", "week", u, 7, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("мес", "mon", "месяц", "month", u, 30, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1713("г", "year", "год", "year", u, 365, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSC = Unit._new1709("°C", "°C", "градус Цельсия", "celsius degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSF = Unit._new1709("°F", "°F", "градус Фаренгейта", "Fahrenheit degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UPERCENT = Unit._new1709("%", "%", "процент", "percent", MeasureKind.PERCENT)
        ...
        uu = Unit._new1760("л.с.", "hp", "лошадиная сила", "horsepower", u, 735.49875)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1768("Ач", "Ah", "ампер-час", "ampere-hour", u, UnitsHelper.UHOUR)
        ...
        uu = Unit._new1760("бар", "bar", "бар", "bar", u, 100000)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new119("БАР", uu)
        t.add_variant("BAR", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1760("мм.рт.ст.", "mm Hg", "миллиметр ртутного столба", "millimeter of mercury", u, 133.332)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1760("кгс", "kgf", "килограмм-сила", "kilogram-force", u, 1000)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1709("IP", "IP", "IP", "IP", MeasureKind.IP)
    ...
    def __add_factor(f : 'UnitsFactors', u0 : 'Unit', abbr_cyr : str, abbr_lat : str, names_ru : str, names_ua : str, names_en : str) -> 'Unit':
        ...
        if (swichVal == UnitsFactors.CENTI): 
            ...
            pref_en = "TERA"
            mult = (1000000000000)
        u = Unit._new1795(pref_cyr.lower() + u0.name_cyr, pref_lat.lower() + u0.name_lat, pref_ru.lower() + u0.fullname_cyr, pref_en.lower() + u0.fullname_lat, f, mult, u0, u0.kind, u0.keywords)
