...
class UnitsHelper:
    ...
    def initialize() -> None:
        ...
        uu = Unit._new1647("миль", "mile", "морская миля", "mile", MeasureKind.LENGTH)
        uu.base_unit = u
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("фут", "ft", "фут", "foot", u, 0.304799472, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new100("ФУТ", uu)
        t.add_abridge("FT.")
        t.add_variant("FOOT", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("дюйм", "in", "дюйм", "inch", u, 0.0254, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        ...
        uu = Unit._new1651("ц", "centner", "центнер", "centner", u, 100000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("Ц.")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("т", "t", "тонна", "tonne", u, 1000000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        uu = Unit._new1651("галлон", "gallon", "галлон", "gallon", u, 4.5461, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("ГАЛ")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("баррель", "bbls", "баррель нефти", "barrel", u, 158.987, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_variant("DAY", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("нед", "week", "неделя", "week", u, 7, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("мес", "mon", "месяц", "month", u, 30, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1651("г", "year", "год", "year", u, 365, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSC = Unit._new1647("°C", "°C", "градус Цельсия", "celsius degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSF = Unit._new1647("°F", "°F", "градус Фаренгейта", "Fahrenheit degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UPERCENT = Unit._new1647("%", "%", "процент", "percent", MeasureKind.PERCENT)
        ...
        uu = Unit._new1698("л.с.", "hp", "лошадиная сила", "horsepower", u, 735.49875)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1706("Ач", "Ah", "ампер-час", "ampere-hour", u, UnitsHelper.UHOUR)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1698("мм.рт.ст.", "mm Hg", "миллиметр ртутного столба", "millimeter of mercury", u, 133.332)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1698("кгс", "kgf", "килограмм-сила", "kilogram-force", u, 1000)
        UnitsHelper.UNITS.append(uu)
    ...
    def __add_factor(f : 'UnitsFactors', u0 : 'Unit', abbr_cyr : str, abbr_lat : str, names_ru : str, names_ua : str, names_en : str) -> 'Unit':
        ...
        if (swichVal == UnitsFactors.CENTI): 
            ...
            pref_en = "TERA"
            mult = (1000000000000)
        u = Unit._new1733(pref_cyr.lower() + u0.name_cyr, pref_lat.lower() + u0.name_lat, pref_ru.lower() + u0.fullname_cyr, pref_en.lower() + u0.fullname_lat, f, mult, u0, u0.kind, u0.keywords)
