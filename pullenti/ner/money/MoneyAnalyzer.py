...
class MoneyAnalyzer(Analyzer):
    ...
    def images(self) -> typing.List[tuple]:
        res = dict()
        res[MoneyMeta.IMAGE_ID] = EpNerBankInternalResourceHelper.get_bytes("money2.png")
        res[MoneyMeta.IMAGE2ID] = EpNerBankInternalResourceHelper.get_bytes("moneyerr.png")
        return res
