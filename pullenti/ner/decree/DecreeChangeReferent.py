...
class DecreeChangeReferent(Referent):
    ...
    def parent_referent(self) -> 'Referent':
        return (self.get_value(DecreeChangeReferent.ATTR_OWNER) if isinstance(self.get_value(DecreeChangeReferent.ATTR_OWNER), Referent) else None)
    ...
    def value(self) -> 'DecreeChangeValueReferent':
        ...
        return (self.get_value(DecreeChangeReferent.ATTR_VALUE) if isinstance(self.get_value(DecreeChangeReferent.ATTR_VALUE), DecreeChangeValueReferent) else None)
    ...
    def param(self) -> 'DecreeChangeValueReferent':
        ...
        from pullenti.ner.decree.DecreeChangeValueReferent import DecreeChangeValueReferent
        return (self.get_value(DecreeChangeReferent.ATTR_PARAM) if isinstance(self.get_value(DecreeChangeReferent.ATTR_PARAM), DecreeChangeValueReferent) else None)
    ...
    @staticmethod
    def _new1023(_arg1 : 'DecreeChangeKind') -> 'DecreeChangeReferent':
