...
class PersonItemToken(MetaToken):
    ...
    class MorphPersonItemVariant(MorphBaseInfo):
        ...
        @staticmethod
        def _new2432(_arg1 : str, _arg2 : 'MorphBaseInfo', _arg3 : bool, _arg4 : str) -> 'MorphPersonItemVariant':
    ...
    class MorphPersonItem:
        ...
        def is_china_surname(self) -> bool:
            ...
            if (Utils.indexOfList(PersonItemToken.MorphPersonItem.__m_lastname_asian, term_, 0) >= 0): 
                return True
            tr = PersonReferent._DelSurnameEnd(term_)
        ...
        def mergeHiphen(self, second : 'MorphPersonItem') -> None:
            addvars = list()
            for v in self.vars0_: 
                ok = 0
        ...
        def addPrefix(self, val : str) -> None:
            if (self.term is not None): 
        ...
        def addPostfix(self, val : str, gen : 'MorphGender') -> None:
            if (self.term is not None): 
        ...
        def mergeWithByHiphen(self, pi0_ : 'MorphPersonItem') -> None:
            ...
            if (len(pi0_.vars0_) == 0): 
                if (pi0_.term is not None): 
                    self.addPostfix(pi0_.term, MorphGender.UNDEFINED)
                return
            if (len(self.vars0_) == 0): 
                if (self.term is not None): 
                    pi0_.addPrefix(self.term + "-")
        ...
        def correctLastnameVariants(self) -> None:
            self.is_lastname_has_std_tail = False
            for v in self.vars0_: 
                if (v.value is not None and (((PersonItemToken.MorphPersonItem.endsWithStdSurname(v.value) or LanguageHelper.endsWith(v.value, "АЯ") or LanguageHelper.endsWith(v.value, "ОЙ")) or LanguageHelper.endsWith(v.value, "ИЙ") or LanguageHelper.endsWith(v.value, "ЫЙ")))): 
                    self.is_lastname_has_std_tail = True
                    break
            if (self.is_lastname_has_std_tail): 
                for i in range(len(self.vars0_) - 1, -1, -1):
                    if ((((self.vars0_[i].value is not None and not PersonItemToken.MorphPersonItem.endsWithStdSurname(self.vars0_[i].value) and not LanguageHelper.endsWith(self.vars0_[i].value, "АЯ")) and not LanguageHelper.endsWith(self.vars0_[i].value, "ОЙ") and not LanguageHelper.endsWith(self.vars0_[i].value, "ИЙ")) and not LanguageHelper.endsWith(self.vars0_[i].value, "ЫЙ") and not LanguageHelper.endsWith(self.vars0_[i].value, "ИХ")) and not LanguageHelper.endsWith(self.vars0_[i].value, "ЫХ")): 
                        del self.vars0_[i]
                        continue
                    if (self.vars0_[i].gender == MorphGender.UNDEFINED): 
                        ...
                        if (del0_): 
                            del self.vars0_[i]
                            continue
                        t = PersonItemToken.MorphPersonItem.__findTail(self.vars0_[i].value)
                        if (t is not None): 
                            if (t.gender != MorphGender.UNDEFINED): 
                                self.vars0_[i].gender = t.gender
                        elif (LanguageHelper.endsWithEx(self.vars0_[i].value, "А", "Я", None, None)): 
        ...
        def initialize() -> None:
            ...
            for s in Utils.splitString(EpNerPersonInternalResourceHelper.getString("chinasurnames.txt"), '\n', False): 
        ...
        @staticmethod
        def __findTail(val : str) -> 'SurnameTail':
            if (val is None): 
                return None
            i = 0
            while i < len(PersonItemToken.MorphPersonItem.__m_lastname_std_tails): 
                if (LanguageHelper.endsWith(val, PersonItemToken.MorphPersonItem.__m_lastname_std_tails[i].tail)): 
                    return PersonItemToken.MorphPersonItem.__m_lastname_std_tails[i]
                i += 1
            return None
        
        @staticmethod
        def endsWithStdSurname(val : str) -> bool:
            return PersonItemToken.MorphPersonItem.__findTail(val) is not None
        
        @staticmethod
        def _new2381(_arg1 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.is_has_std_postfix = _arg1
            return res
        
        @staticmethod
        def _new2389(_arg1 : str) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.term = _arg1
            return res
        
        @staticmethod
        def _new2392(_arg1 : str, _arg2 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
            res.term = _arg1
        ...
        @staticmethod
        def _new2422(_arg1 : bool) -> 'MorphPersonItem':
            res = PersonItemToken.MorphPersonItem()
    ...
    def isAsianItem(self, last : bool) -> bool:
        ...
        while i < len(self.value): 
            ch = self.value[i]
            if (not LanguageHelper.isCyrillicChar(ch)): 
                return False
            elif (LanguageHelper.isCyrillicVowel(ch)): 
                if (not prev_glas): 
                    if (gl > 0): 
                        if (not last): 
                            return False
    ...
    def __addPostfixInfo(self, postfix : str, gen : 'MorphGender') -> None:
        if (self.value is not None): 
            self.value = "{0}-{1}".format(self.value, postfix)
        if (self.lastname is not None): 
            self.lastname.addPostfix(postfix, gen)
        if (self.firstname is not None): 
            self.firstname.addPostfix(postfix, gen)
        elif (self.lastname is not None): 
            self.firstname = self.lastname
        else: 
            self.firstname = PersonItemToken.MorphPersonItem._new2381(True)
            self.firstname.vars0_.append(PersonItemToken.MorphPersonItemVariant(self.value, MorphBaseInfo._new2382(gen), False))
            if (self.lastname is None): 
                self.lastname = self.firstname
        if (self.middlename is not None): 
            self.middlename.addPostfix(postfix, gen)
        elif (self.firstname is not None and not self.chars.is_latin_letter): 
            self.middlename = self.firstname
        self.is_in_dictionary = False
    
    def mergeWithByHiphen(self, pi0_ : 'PersonItemToken') -> None:
        ...
        if (self.lastname is not None): 
            if (pi0_.lastname is None or len(pi0_.lastname.vars0_) == 0): 
                self.lastname.addPostfix(pi0_.value, MorphGender.UNDEFINED)
            else: 
                self.lastname.mergeWithByHiphen(pi0_.lastname)
        elif (pi0_.lastname is not None): 
            pi0_.lastname.addPrefix(self.value + "-")
            self.lastname = pi0_.lastname
        if (self.firstname is not None): 
            if (pi0_.firstname is None or len(pi0_.firstname.vars0_) == 0): 
                self.firstname.addPostfix(pi0_.value, MorphGender.UNDEFINED)
            else: 
                self.firstname.mergeWithByHiphen(pi0_.firstname)
        elif (pi0_.firstname is not None): 
            pi0_.firstname.addPrefix(self.value + "-")
            self.firstname = pi0_.firstname
        if (self.middlename is not None): 
            if (pi0_.middlename is None or len(pi0_.middlename.vars0_) == 0): 
                self.middlename.addPostfix(pi0_.value, MorphGender.UNDEFINED)
            else: 
                self.middlename.mergeWithByHiphen(pi0_.middlename)
        elif (pi0_.middlename is not None): 
            pi0_.middlename.addPrefix(self.value + "-")
            self.middlename = pi0_.middlename
    
    @staticmethod
    def tryAttachLatin(t : 'Token') -> 'PersonItemToken':
        ...
        if (tt is None): 
            ...
            if (mt is not None and mt.begin_token == mt.end_token): 
                res00 = PersonItemToken.tryAttachLatin(mt.begin_token)
        ...
        if (tt.term == "JR" or tt.term == "JNR" or tt.term == "JUNIOR"): 
            ...
            if (tt.next0_ is not None and tt.next0_.isChar('.')): 
                t1 = tt.next0_
            return PersonItemToken._new2383(tt, t1, PersonItemToken.ItemType.SUFFIX, "JUNIOR")
        if ((tt.term == "SR" or tt.term == "SNR" or tt.term == "SENIOR") or tt.term == "FITZ" or tt.term == "FILS"): 
            t1 = tt
            if (tt.next0_ is not None and tt.next0_.isChar('.')): 
                t1 = tt.next0_
            return PersonItemToken._new2383(tt, t1, PersonItemToken.ItemType.SUFFIX, "SENIOR")
        ...
        if (not initials and len(tt.term) == 2 and tt.chars.is_capital_upper): 
            if (not LanguageHelper.isLatinVowel(tt.term[0]) and not LanguageHelper.isLatinVowel(tt.term[1])): 
                initials = True
        if (initials): 
            rii = PersonItemToken._new2385(tt, tt, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
            if (tt.next0_ is not None and tt.next0_.isChar('.')): 
        ...
        if (tt.length_char == 1): 
            if (tt.next0_ is None): 
                return None
            if (tt.next0_.isChar('.')): 
                return PersonItemToken._new2385(tt, tt.next0_, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
            if (not tt.next0_.is_whitespace_after and not tt.is_whitespace_after and ((tt.term == "D" or tt.term == "O" or tt.term == "M"))): 
                if (BracketHelper.isBracket(tt.next0_, False) and (isinstance(tt.next0_.next0_, TextToken))): 
                    if (tt.next0_.next0_.chars.is_latin_letter): 
                        pit0 = PersonItemToken.tryAttachLatin(tt.next0_.next0_)
                        if (pit0 is not None and pit0.typ == PersonItemToken.ItemType.VALUE): 
                            ...
                            return pit0
            if (not LanguageHelper.isLatinVowel(tt.term[0]) or tt.whitespaces_after_count != 1): 
                nex = PersonItemToken.tryAttachLatin(tt.next0_)
                if (nex is not None and nex.typ == PersonItemToken.ItemType.VALUE): 
                    return PersonItemToken._new2385(tt, tt, PersonItemToken.ItemType.INITIAL, tt.term, tt.chars)
                return None
            if (tt.term == "I"): 
                return None
            return PersonItemToken._new2385(tt, tt, PersonItemToken.ItemType.VALUE, tt.term, tt.chars)
        if (not MiscHelper.hasVowel(tt)): 
            return None
        ...
        if (cla.is_proper_name or ((cla.is_proper and ((tt.morph.gender == MorphGender.MASCULINE or tt.morph.gender == MorphGender.FEMINIE))))): 
            res.firstname = PersonItemToken.MorphPersonItem._new2389(res.value)
        ...
        if (cla.is_proper_surname): 
            res.lastname = PersonItemToken.MorphPersonItem._new2389(res.value)
            for wf in tt.morph.items: 
                if ((Utils.asObjectOrNull(wf, MorphWordForm)).is_in_dictionary): 
        ...
        if (ots is not None): 
            if (ots[0].termin.ignore_terms_order): 
                return PersonItemToken._new2391(ots[0].begin_token, ots[0].end_token, PersonItemToken.ItemType.REFERENT, Utils.asObjectOrNull(ots[0].item.tag, PersonReferent), ots[0].morph)
            res.lastname = PersonItemToken.MorphPersonItem._new2392(ots[0].termin.canonic_text, True)
            for ot in ots: 
                if (ot.termin is not None): 
                    mi = ot.morph
                    if (ot.termin.gender == MorphGender.MASCULINE or ot.termin.gender == MorphGender.FEMINIE): 
                        mi = MorphBaseInfo._new2382(ot.termin.gender)
        ...
        if (res.value.startswith("MAC")): 
            ...
            res.lastname = PersonItemToken.MorphPersonItem._new2381(True)
            res.lastname.vars0_.append(PersonItemToken.MorphPersonItemVariant(res.value, MorphBaseInfo(), True))
        return res
    
    @staticmethod
    def tryAttach(t : 'Token', loc_ont : 'IntOntologyCollection', attrs : 'ParseAttr'=ParseAttr.NO, prev_list : typing.List['PersonItemToken']=None) -> 'PersonItemToken':
        from pullenti.ner.TextToken import TextToken
        ...
        if (isinstance(t, NumberToken)): 
            ...
            if (nt.begin_token == nt.end_token and nt.typ == NumberSpellingType.WORDS and ((not nt.begin_token.chars.is_all_lower or (((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) != (PersonItemToken.ParseAttr.NO)))): 
                res00 = PersonItemToken.tryAttach(nt.begin_token, loc_ont, attrs, prev_list)
                if (res00 is not None): 
                    res00.begin_token = res00.end_token = t
                    return res00
        if ((((isinstance(t, TextToken)) and t.length_char == 2 and (Utils.asObjectOrNull(t, TextToken)).term == "JI") and t.chars.is_all_upper and not t.is_whitespace_after) and t.next0_ is not None and t.next0_.isChar('.')): 
            re1 = PersonItemToken._new2383(t, t.next0_, PersonItemToken.ItemType.INITIAL, "Л")
            re1.chars.is_cyrillic_letter = True
            re1.chars.is_all_upper = True
            return re1
        if ((((((isinstance(t, TextToken)) and t.length_char == 1 and (Utils.asObjectOrNull(t, TextToken)).term == "J") and t.chars.is_all_upper and not t.is_whitespace_after) and (isinstance(t.next0_, NumberToken)) and (Utils.asObjectOrNull(t.next0_, NumberToken)).value == (1)) and (Utils.asObjectOrNull(t.next0_, NumberToken)).typ == NumberSpellingType.DIGIT and t.next0_.next0_ is not None) and t.next0_.next0_.isChar('.')): 
            re1 = PersonItemToken._new2383(t, t.next0_.next0_, PersonItemToken.ItemType.INITIAL, "Л")
            re1.chars.is_cyrillic_letter = True
            re1.chars.is_all_upper = True
            return re1
        if ((((((isinstance(t, TextToken)) and t.length_char == 1 and (Utils.asObjectOrNull(t, TextToken)).term == "I") and t.chars.is_all_upper and not t.is_whitespace_after) and (isinstance(t.next0_, NumberToken)) and (Utils.asObjectOrNull(t.next0_, NumberToken)).value == (1)) and (Utils.asObjectOrNull(t.next0_, NumberToken)).typ == NumberSpellingType.DIGIT and t.next0_.next0_ is not None) and t.next0_.next0_.isChar('.')): 
            if (prev_list is not None and prev_list[0].chars.is_cyrillic_letter): 
                re1 = PersonItemToken._new2383(t, t.next0_.next0_, PersonItemToken.ItemType.INITIAL, "П")
                re1.chars.is_cyrillic_letter = True
                re1.chars.is_all_upper = True
                return re1
        if (loc_ont is not None and len(loc_ont.items) > 1000): 
            loc_ont = (None)
        res = PersonItemToken.__tryAttach(t, loc_ont, attrs, prev_list)
        if (res is not None): 
            return res
        if (t.chars.is_latin_letter and (((attrs) & (PersonItemToken.ParseAttr.CANBELATIN))) != (PersonItemToken.ParseAttr.NO)): 
            ...
            if (loc_ont is not None): 
                ots = loc_ont.tryAttach(t, PersonReferent.OBJ_TYPENAME, False)
            if (t is not None and t.kit.ontology is not None and ots is None): 
                ots = t.kit.ontology.attachToken(PersonReferent.OBJ_TYPENAME, t)
            if (ots is not None and (isinstance(t, TextToken))): 
                if (ots[0].termin.ignore_terms_order): 
                    return PersonItemToken._new2391(ots[0].begin_token, ots[0].end_token, PersonItemToken.ItemType.REFERENT, Utils.asObjectOrNull(ots[0].item.tag, PersonReferent), ots[0].morph)
                res = PersonItemToken._new2399(ots[0].begin_token, ots[0].end_token, (Utils.asObjectOrNull(t, TextToken)).term, ots[0].chars)
                res.lastname = PersonItemToken.MorphPersonItem._new2392(ots[0].termin.canonic_text, True)
                for ot in ots: 
                    if (ot.termin is not None): 
                        mi = ot.morph
            ...
            if (res is not None): 
                return res
        if (((isinstance(t, NumberToken)) and t.length_char == 1 and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) != (PersonItemToken.ParseAttr.NO)) and t.next0_ is not None and t.next0_.isCharOf(".„")): 
            if ((Utils.asObjectOrNull(t, NumberToken)).value == (1)): 
                return PersonItemToken._new2385(t, t.next0_, PersonItemToken.ItemType.INITIAL, "І", CharsInfo._new2402(True))
            if ((Utils.asObjectOrNull(t, NumberToken)).value == (0)): 
                return PersonItemToken._new2385(t, t.next0_, PersonItemToken.ItemType.INITIAL, "О", CharsInfo._new2402(True))
            if ((Utils.asObjectOrNull(t, NumberToken)).value == (3)): 
                return PersonItemToken._new2385(t, t.next0_, PersonItemToken.ItemType.INITIAL, "З", CharsInfo._new2402(True))
        if ((((isinstance(t, NumberToken)) and t.length_char == 1 and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) != (PersonItemToken.ParseAttr.NO)) and t.next0_ is not None and t.next0_.chars.is_all_lower) and not t.is_whitespace_after and t.next0_.length_char > 2): 
            ...
            if (num == (3) and t.next0_.chars.is_cyrillic_letter): 
                return PersonItemToken._new2385(t, t.next0_, PersonItemToken.ItemType.VALUE, "З" + (Utils.asObjectOrNull(t.next0_, TextToken)).term, CharsInfo._new2408(True, True))
            if (num == (0) and t.next0_.chars.is_cyrillic_letter): 
                return PersonItemToken._new2385(t, t.next0_, PersonItemToken.ItemType.VALUE, "О" + (Utils.asObjectOrNull(t.next0_, TextToken)).term, CharsInfo._new2408(True, True))
        if (((((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter) and t.chars.is_all_upper and (t.whitespaces_after_count < 2)) and (isinstance(t.next0_, TextToken)) and t.next0_.length_char == 1) and t.next0_.chars.is_all_lower): 
            ...
            lat = 0
            cyr = 0
            ch = (Utils.asObjectOrNull(t, TextToken)).getSourceText()[0]
            if (t.chars.is_cyrillic_letter): 
                cyr += 1
                if ((ord(LanguageHelper.getLatForCyr(ch))) != 0): 
                    lat += 1
            else: 
                lat += 1
                if ((ord(LanguageHelper.getCyrForLat(ch))) != 0): 
                    cyr += 1
            tt = t.next0_
            while tt is not None: 
                ...
                t1 = tt
                cou += 1
                ch = (Utils.asObjectOrNull(tt, TextToken)).getSourceText()[0]
                if (tt.chars.is_cyrillic_letter): 
                    cyr += 1
                    if ((ord(LanguageHelper.getLatForCyr(ch))) != 0): 
                        lat += 1
            ...
            if (cou < 5): 
                if (prev_list is not None and len(prev_list) > 0 and prev_list[len(prev_list) - 1].typ == PersonItemToken.ItemType.INITIAL): 
                    ...
                    ne = PersonItemToken.tryAttach(t1.next0_, loc_ont, attrs, None)
            ...
            while tt is not None and tt.end_char <= t1.end_char: 
                ch = (Utils.asObjectOrNull(tt, TextToken)).getSourceText()[0]
                if (is_cyr and LanguageHelper.isLatinChar(ch)): 
                    chh = LanguageHelper.getCyrForLat(ch)
                    if ((ord(chh)) != 0): 
                        ch = chh
                elif (not is_cyr and LanguageHelper.isCyrillicChar(ch)): 
                    chh = LanguageHelper.getLatForCyr(ch)
                    if ((ord(chh)) != 0): 
                        ch = chh
                print(str.upper(ch), end="", file=val)
                tt = tt.next0_
            res = PersonItemToken._new2383(t, t1, PersonItemToken.ItemType.VALUE, Utils.toStringStringIO(val))
            res.chars = CharsInfo._new2413(True, is_cyr, not is_cyr, True)
            return res
        if ((((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) != (PersonItemToken.ParseAttr.NO) and (isinstance(t, TextToken)) and not t.chars.is_all_lower): 
            res = PersonItemToken._new2414(t, t, (Utils.asObjectOrNull(t, TextToken)).term)
            return res
        return None
    
    @staticmethod
    def __tryAttach(t : 'Token', loc_ont : 'IntOntologyCollection', attrs : 'ParseAttr', prev_list : typing.List['PersonItemToken']=None) -> 'PersonItemToken':
        from pullenti.ner.TextToken import TextToken
        from pullenti.ner.ReferentToken import ReferentToken
        from pullenti.ner.person.PersonReferent import PersonReferent
        from pullenti.ner.core.BracketHelper import BracketHelper
        ...
        if (tt is None): 
            if (t.chars.is_letter and t.chars.is_capital_upper and (isinstance(t, ReferentToken))): 
                ...
                if (rt.begin_token == rt.end_token and not ((isinstance(rt.referent, PersonReferent)))): 
                    res0 = PersonItemToken.__tryAttach(rt.begin_token, loc_ont, attrs, None)
                    if (res0 is None): 
                        res0 = PersonItemToken._new2415(rt, rt, rt.referent.toString(True, t.kit.base_language, 0).upper(), rt.chars, rt.morph)
                        res0.lastname = PersonItemToken.MorphPersonItem._new2389(res0.value)
                    else: 
                        res0.begin_token = res0.end_token = rt
                    if ((t.next0_ is not None and t.next0_.is_hiphen and (isinstance(t.next0_.next0_, TextToken))) and t.next0_.next0_.getMorphClassInDictionary().is_proper_secname): 
                        res1 = PersonItemToken.tryAttach(t.next0_.next0_, loc_ont, PersonItemToken.ParseAttr.NO, None)
        ...
        if (tt.chars.is_all_lower and (((attrs) & (PersonItemToken.ParseAttr.CANBELOWER))) == (PersonItemToken.ParseAttr.NO)): 
            if (not tt.term in PersonItemToken.M_SUR_PREFIXES): 
                if (((tt.term == "Д" and not tt.is_whitespace_after and BracketHelper.isBracket(tt.next0_, True)) and not tt.next0_.is_whitespace_after and (isinstance(tt.next0_.next0_, TextToken))) and tt.next0_.next0_.chars.is_capital_upper): 
                    pass
                else: 
                    return None
        if (tt.length_char == 1 or tt.term == "ДЖ"): 
            ...
            if (not tt.chars.is_cyrillic_letter): 
                cyr = LanguageHelper.getCyrForLat(ini[0])
                if (cyr == (chr(0))): 
                    return None
                ini = "{0}".format(cyr)
            ...
            if (tt.next0_.isChar('.')): 
                return PersonItemToken._new2385(tt, tt.next0_, PersonItemToken.ItemType.INITIAL, ini, ci)
            if ((tt.next0_.isCharOf(",;„") and prev_list is not None and len(prev_list) > 0) and prev_list[len(prev_list) - 1].typ == PersonItemToken.ItemType.INITIAL): 
                return PersonItemToken._new2385(tt, tt, PersonItemToken.ItemType.INITIAL, ini, ci)
            if ((tt.next0_.whitespaces_after_count < 2) and (tt.whitespaces_after_count < 2) and ((tt.term == "Д" or tt.term == "О" or tt.term == "Н"))): 
                if (BracketHelper.isBracket(tt.next0_, False) and (isinstance(tt.next0_.next0_, TextToken))): 
                    if (tt.next0_.next0_.chars.is_cyrillic_letter): 
                        pit0 = PersonItemToken.tryAttach(tt.next0_.next0_, loc_ont, Utils.valToEnum((attrs) | (PersonItemToken.ParseAttr.CANBELOWER), PersonItemToken.ParseAttr), prev_list)
                        if (pit0 is not None): 
                            pit0.begin_token = tt
                            if (pit0.value is not None): 
                            ...
                            if (not pit0.chars.is_all_upper and not pit0.chars.is_capital_upper): 
                                pit0.chars.is_capital_upper = True
                            return pit0
            if (not LanguageHelper.isCyrillicVowel(tt.term[0]) or tt.whitespaces_after_count != 1): 
                return None
            return PersonItemToken._new2385(tt, tt, PersonItemToken.ItemType.VALUE, tt.term, tt.chars)
        if (not tt.chars.is_cyrillic_letter): 
            return None
        ...
        if (ots is not None): 
            if (ots[0].termin.ignore_terms_order): 
                return PersonItemToken._new2391(ots[0].begin_token, ots[0].end_token, PersonItemToken.ItemType.REFERENT, Utils.asObjectOrNull(ots[0].item.tag, PersonReferent), ots[0].morph)
            res = PersonItemToken._new2399(ots[0].begin_token, ots[0].end_token, tt.term, ots[0].chars)
            res.lastname = PersonItemToken.MorphPersonItem._new2422(True)
            ...
            res = PersonItemToken._new2415(t, t, tt.term, tt.chars, tt.morph)
            if (tt.term in PersonItemToken.M_SUR_PREFIXES): 
                if (((tt.isValue("БЕН", None) or tt.isValue("ВАН", None))) and (((attrs) & (PersonItemToken.ParseAttr.ALTVAR))) != (PersonItemToken.ParseAttr.NO) and ((tt.next0_ is None or not tt.next0_.is_hiphen))): 
                    pass
                else: 
                    ...
                    if (sur_prefix is None): 
                        if (t.chars.is_capital_upper or t.chars.is_all_upper): 
                            return res
                        return None
        if (tt.isValue("ФАМИЛИЯ", "ПРІЗВИЩЕ") or tt.isValue("ИМЯ", "ІМЯ") or tt.isValue("ОТЧЕСТВО", "БАТЬКОВІ")): 
            return None
        if (tt.morph.class0_.is_preposition or tt.morph.class0_.is_conjunction): 
            if (tt.getMorphClassInDictionary().is_proper_name): 
                pass
            elif (tt.next0_ is None or not tt.next0_.isChar('.')): 
                if (tt.length_char > 1 and tt.chars.is_capital_upper and not MiscHelper.canBeStartOfSentence(tt)): 
                    pass
                else: 
                    return None
        if ((((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) != (PersonItemToken.ParseAttr.NO)): 
            ...
            if (tt.length_char > 6 and tt.term.startswith("УВ")): 
                if (tt.isValue("УВАЖАЕМЫЙ", None)): 
                    return None
            if (tt.length_char > 6 and tt.term.startswith("ДО")): 
                if (tt.isValue("ДОРОГОЙ", None)): 
                    return None
        ...
        for wff in tt.morph.items: 
            ...
            if (wf is None): 
                continue
            if (wf.class0_.is_adjective and wf.containsAttr("к.ф.", MorphClass())): 
                if (wf.is_in_dictionary): 
                    if (LanguageHelper.endsWith(tt.term, "НО") or ((tt.next0_ is not None and tt.next0_.is_hiphen))): 
                        res.is_in_dictionary = True
                continue
            ...
            if (wf.class0_.is_proper_surname or sur_prefix is not None): 
                if (res.lastname is None): 
                    res.lastname = PersonItemToken.MorphPersonItem._new2389(tt.term)
                if (adj is not None): 
                ...
                if (wf.normal_case != tt.term and LanguageHelper.endsWith(tt.term, "ОВ")): 
                    v.value = tt.term
                ...
                if (tt.term.endswith("ИХ") or tt.term.endswith("ЫХ")): 
                    if (res.lastname.vars0_[0].value != tt.term): 
                        res.lastname.vars0_.insert(0, PersonItemToken.MorphPersonItemVariant(tt.term, MorphBaseInfo._new2428(MorphCase.ALL_CASES, Utils.valToEnum((MorphGender.MASCULINE) | (MorphGender.FEMINIE), MorphGender), MorphClass._new2427(True)), True))
            ...
            if (wf.class0_.is_proper_name and wf.number != MorphNumber.PLURAL): 
                ...
                if (t.morph.language.is_ua): 
                    ...
                    ok = (not LanguageHelper.endsWith(wf.normal_case, "ОВ") and wf.normal_case != "АЛЛ")
                    if (ok): 
                        if (tt.chars.is_all_upper and (tt.length_char < 4)): 
                            ok = False
                if (ok): 
                    if (res.firstname is None): 
                        res.firstname = PersonItemToken.MorphPersonItem._new2389(tt.term)
                    ...
                    if (wf.is_in_dictionary): 
                        if (not tt.chars.is_all_upper or tt.length_char > 4): 
                            res.firstname.is_in_dictionary = True
            if (not PersonItemToken.MorphPersonItem.endsWithStdSurname(tt.term)): 
                if (wf.class0_.is_proper_secname): 
                    if (res.middlename is None): 
                        res.middlename = PersonItemToken.MorphPersonItem._new2389(tt.term)
                ...
                if (not wf.class0_.is_proper and wf.is_in_dictionary): 
                    res.is_in_dictionary = True
            elif (wf.is_in_dictionary and not wf.class0_.is_proper and LanguageHelper.endsWith(tt.term, "КО")): 
                res.is_in_dictionary = True
        if (res.lastname is not None): 
            ...
            if (not res.lastname.is_in_dictionary): 
                if (((not res.lastname.is_in_dictionary and not res.lastname.is_lastname_has_std_tail)) or PersonItemToken.MorphPersonItem.endsWithStdSurname(tt.term)): 
                    v = PersonItemToken.MorphPersonItemVariant(tt.term, None, True)
                    if (LanguageHelper.endsWithEx(tt.term, "ВА", "НА", None, None)): 
                        res.lastname.vars0_.insert(0, v)
                    else: 
                        res.lastname.vars0_.append(v)
                    if (PersonItemToken.MorphPersonItem.endsWithStdSurname(v.value) and not res.lastname.is_in_dictionary): 
                        res.lastname.is_lastname_has_std_tail = True
            ...
            for wf in tt.morph.items: 
                if (not wf.class0_.is_verb): 
                    if (wf.containsAttr("к.ф.", MorphClass())): 
                        continue
                    res.lastname.vars0_.append(PersonItemToken.MorphPersonItemVariant((Utils.asObjectOrNull(wf, MorphWordForm)).normal_case, wf, True))
                    if (not res.lastname.is_lastname_has_std_tail): 
                        res.lastname.is_lastname_has_std_tail = PersonItemToken.MorphPersonItem.endsWithStdSurname((Utils.asObjectOrNull(wf, MorphWordForm)).normal_case)
            res.lastname.vars0_.append(PersonItemToken.MorphPersonItemVariant(tt.term, None, True))
            if (not res.lastname.is_lastname_has_std_tail): 
                res.lastname.is_lastname_has_std_tail = PersonItemToken.MorphPersonItem.endsWithStdSurname(tt.term)
            if (sur_prefix is not None): 
                res.lastname.addPrefix(sur_prefix + "-")
                res.lastname.is_lastname_has_hiphen = True
        if (res.begin_token == res.end_token): 
            if (res.begin_token.getMorphClassInDictionary().is_verb and res.lastname is not None): 
                if (not res.lastname.is_lastname_has_std_tail and not res.lastname.is_in_dictionary): 
                    res.lastname = (None)
            if (res.lastname is not None and res.begin_token.isValue("ЗАМ", None)): 
                return None
            if (res.firstname is not None and (isinstance(res.begin_token, TextToken))): 
                if ((Utils.asObjectOrNull(res.begin_token, TextToken)).term == "ЛЮБОЙ"): 
                    res.firstname = (None)
            if (res.begin_token.getMorphClassInDictionary().is_adjective and res.lastname is not None): 
        ...
        if (res.firstname is not None): 
            ...
            while True:
                ...
                di = ShortNameHelper.getNamesForShortname(val)
                if (di is None): 
                    continue
                ...
                if (g != MorphGender.MASCULINE and g != MorphGender.FEMINIE): 
                    ...
                    for kp in di: 
                        if (fi): 
                            ...
                            mi = MorphBaseInfo._new2382(kp.gender)
                            res.firstname.vars0_.append(PersonItemToken.MorphPersonItemVariant._new2432(kp.name, mi, False, val))
                else: 
                    cou = 0
                    for kp in di: 
                        if (kp.gender == g): 
                            ...
                            if ((cou) < 2): 
                                ...
                                res.firstname.vars0_.insert(i + 1, PersonItemToken.MorphPersonItemVariant._new2432(kp.name, res.firstname.vars0_[i], False, val))
        if (res is not None and res.is_in_dictionary and res.firstname is None): 
            wi = res.kit.statistics.getWordInfo(res.begin_token)
            if (wi is not None and wi.lower_count > 0): 
                if (((t.morph.class0_.is_preposition or t.morph.class0_.is_conjunction or t.morph.class0_.is_pronoun)) and not MiscHelper.canBeStartOfSentence(t)): 
                    pass
                else: 
                    return None
        if (res.end_token.next0_ is not None and res.end_token.next0_.is_hiphen and (isinstance(res.end_token.next0_.next0_, TextToken))): 
            ter = (Utils.asObjectOrNull(res.end_token.next0_.next0_, TextToken)).term
            if (ter in PersonItemToken.M_ARAB_POSTFIX or ter in PersonItemToken.M_ARAB_POSTFIX_FEM): 
                ...
                res.__addPostfixInfo(ter, (MorphGender.FEMINIE if ter in PersonItemToken.M_ARAB_POSTFIX_FEM else MorphGender.MASCULINE))
                ...
                res1 = PersonItemToken.tryAttach(res.end_token.next0_.next0_, loc_ont, PersonItemToken.ParseAttr.NO, None)
        ...
        while (res.end_token.whitespaces_after_count < 3) and (isinstance(res.end_token.next0_, TextToken)):
            ter = (Utils.asObjectOrNull(res.end_token.next0_, TextToken)).term
    ...
    @staticmethod
    def tryAttachList(t : 'Token', loc_ont : 'IntOntologyCollection', attrs : 'ParseAttr'=ParseAttr.NO, max_count : int=10) -> typing.List['PersonItemToken']:
        from pullenti.ner.TextToken import TextToken
        from pullenti.ner.ReferentToken import ReferentToken
        ...
        if (((not ((isinstance(t, TextToken))) or not t.chars.is_letter)) and (((attrs) & (PersonItemToken.ParseAttr.CANINITIALBEDIGIT))) == (PersonItemToken.ParseAttr.NO)): 
            if ((isinstance(t, ReferentToken)) and (isinstance(t.getReferent(), GeoReferent)) and (Utils.asObjectOrNull(t, ReferentToken)).begin_token == (Utils.asObjectOrNull(t, ReferentToken)).end_token): 
                pass
                ...
                return None
        pit = PersonItemToken.tryAttach(t, loc_ont, attrs, None)
        ...
        if ((t is not None and t.isChar('.') and pit.typ == PersonItemToken.ItemType.VALUE) and pit.length_char > 3): 
            str0_ = pit.getSourceText()
            if (str.isupper(str0_[0]) and str.isupper(str0_[len(str0_) - 1])): 
                ...
                if (ok): 
                    ...
                    pit2 = PersonItemToken._new2383(t, t, PersonItemToken.ItemType.INITIAL, str0_[len(str0_) - 1:])
                    res.append(pit2)
                    t = t.next0_
        zap = False
        while t is not None: 
            ...
            if (tt.is_hiphen and tt.next0_ is not None): 
                if (not tt.is_whitespace_after and not tt.is_whitespace_before): 
                    ...
                    tt = tt.next0_
            elif ((tt.isChar(',') and (tt.whitespaces_after_count < 2) and tt.next0_ is not None) and len(res) == 1): 
                zap = True
                tt = tt.next0_
            elif ((tt.isChar('(') and (isinstance(tt.next0_, TextToken)) and tt.next0_.chars == tt.previous.chars) and tt.next0_.next0_ is not None and tt.next0_.next0_.isChar(')')): 
                pit0 = res[len(res) - 1]
                pit11 = PersonItemToken.tryAttach(tt.next0_, loc_ont, attrs, None)
                if (pit0.firstname is not None and pit11 is not None and pit11.firstname is not None): 
                    ...
                    if (pit11 is not None and pit11.lastname is not None): 
                        if ((pit11.lastname.is_in_dictionary or pit11.lastname.is_lastname_has_std_tail or pit11.lastname.is_has_std_postfix)): 
                            ...
                            pit0.end_token = tt
                            tt = tt.next0_
            pit1 = PersonItemToken.tryAttach(tt, loc_ont, attrs, res)
            if (pit1 is None): 
                break
                ...
                if (pit1.typ == PersonItemToken.ItemType.INITIAL): 
                    if (pit1.chars.is_cyrillic_letter): 
                        ...
                        if (v != (chr(0))): 
                            pit1.value = "{0}".format(v)
                            ok = True
                            pit1.chars = CharsInfo._new2402(True)
                        elif (pit.typ == PersonItemToken.ItemType.INITIAL): 
                            v = LanguageHelper.getLatForCyr(pit.value[0])
                            if (v != (chr(0))): 
                                pit.value = "{0}".format(v)
                                ok = True
                                pit.chars = CharsInfo._new2435(True)
                                pit = pit1
                elif (pit.typ == PersonItemToken.ItemType.INITIAL): 
            ...
            if (pit1.typ == PersonItemToken.ItemType.VALUE or ((pit1.typ == PersonItemToken.ItemType.SUFFIX and pit1.is_newline_before))): 
                if (loc_ont is not None and (((attrs) & (PersonItemToken.ParseAttr.IGNOREATTRS))) == (PersonItemToken.ParseAttr.NO)): 
                    pat = PersonAttrToken.tryAttach(pit1.begin_token, loc_ont, PersonAttrToken.PersonAttrAttachAttrs.NO)
                    if (pat is not None): 
                        if (pit1.is_newline_before): 
                            break
                        if (pit1.lastname is None or not pit1.lastname.is_lastname_has_std_tail): 
                            ty = pit1.begin_token.getMorphClassInDictionary()
                            if (ty.is_noun): 
        ...
        if (res[0].isAsianItem(False) and len(res[0].value) == 1): 
            if ((((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) == (PersonItemToken.ParseAttr.NO)): 
                if (len(res) < 2): 
                    return None
                if (not res[1].isAsianItem(False) or len(res[1].value) == 1): 
                    return None
        ...
        if (len(res) == 1 and res[0].is_newline_before and res[0].is_newline_after): 
            if (res[0].lastname is not None and ((res[0].lastname.is_has_std_postfix or res[0].lastname.is_in_dictionary or res[0].lastname.is_lastname_has_std_tail))): 
                res1 = PersonItemToken.tryAttachList(res[0].end_token.next0_, loc_ont, PersonItemToken.ParseAttr.CANBELATIN, max_count)
                if (res1 is not None and len(res1) > 0): 
                    if (len(res1) == 2 and ((res1[0].firstname is not None or res1[1].middlename is not None)) and res1[1].is_newline_after): 
                        ...
                        res2 = PersonItemToken.tryAttachList(res1[0].end_token.next0_, loc_ont, PersonItemToken.ParseAttr.CANBELATIN, max_count)
        ...
        while True:
            ...
            if (res[i].firstname is not None and res[i].begin_token.isValue("СВЕТА", None)): 
                ...
                res[i].__addPostfixInfo(res[i + 1].value, MorphGender.UNDEFINED)
                res[i].end_token = res[i + 1].end_token
                if (res[i].lastname is None): 
                    res[i].lastname = PersonItemToken.MorphPersonItem._new2381(True)
        ...
        if (len(res) > 1 and res[0].is_in_dictionary and (((attrs) & (PersonItemToken.ParseAttr.MUSTBEITEMALWAYS))) == (PersonItemToken.ParseAttr.NO)): 
            mc = res[0].begin_token.getMorphClassInDictionary()
            if (mc.is_pronoun or mc.is_personal_pronoun): 
                if (res[0].begin_token.isValue("ТОМ", None)): 
                    pass
                else: 
                    return None
        i = 0
    ...
    @staticmethod
    def tryParsePerson(t : 'Token', prev_pers_template : 'FioTemplateType'=FioTemplateType.UNDEFINED) -> 'ReferentToken':
        ...
        if (isinstance(t.getReferent(), PersonReferent)): 
            ...
            if (rt.begin_token == rt.end_token): 
                ...
                if (tt1 is not None and (tt1.whitespaces_before_count < 2)): 
                    pits0 = PersonItemToken.tryAttachList(tt1, None, PersonItemToken.ParseAttr.CANINITIALBEDIGIT, 10)
                    if (pits0 is not None and pits0[0].typ == PersonItemToken.ItemType.INITIAL): 
                        str0_ = rt.referent.getStringValue(PersonReferent.ATTR_FIRSTNAME)
                        if (str0_ is not None and str0_.startswith(pits0[0].value)): 
                            res = ReferentToken._new2440(rt.referent, t, pits0[0].end_token, FioTemplateType.SURNAMEI)
                            if (len(pits0) > 1 and pits0[1].typ == PersonItemToken.ItemType.INITIAL): 
                                str0_ = rt.referent.getStringValue(PersonReferent.ATTR_MIDDLENAME)
                    ...
                    if (((((isinstance(tt1, TextToken)) and tt1.length_char == 1 and tt1.chars.is_all_upper) and tt1.chars.is_cyrillic_letter and (isinstance(tt1.next0_, TextToken))) and (tt1.whitespaces_after_count < 2) and tt1.next0_.length_char == 1) and tt1.next0_.chars.is_all_upper and tt1.next0_.chars.is_cyrillic_letter): 
                        str0_ = rt.referent.getStringValue(PersonReferent.ATTR_FIRSTNAME)
                        if (str0_ is not None and str0_.startswith((Utils.asObjectOrNull(tt1, TextToken)).term)): 
                            str2 = rt.referent.getStringValue(PersonReferent.ATTR_MIDDLENAME)
                            if (str2 is None or str2.startswith((Utils.asObjectOrNull(tt1.next0_, TextToken)).term)): 
                                res = ReferentToken._new2440(rt.referent, t, tt1.next0_, FioTemplateType.NAMEISURNAME)
                                if (str2 is None): 
                                    rt.referent.addSlot(PersonReferent.ATTR_MIDDLENAME, (Utils.asObjectOrNull(tt1.next0_, TextToken)).term, False, 0)
                                if (res.end_token.next0_ is not None and res.end_token.next0_.isChar('.')): 
                                    res.end_token = res.end_token.next0_
                                return res
            return rt
        if (t.getReferent() is not None and t.getReferent().type_name == "ORGANIZATION"): 
            rt = Utils.asObjectOrNull(t, ReferentToken)
            ppp = PersonItemToken.tryParsePerson(rt.begin_token, FioTemplateType.UNDEFINED)
            if (ppp is not None and ppp.end_char == rt.end_char): 
                ppp.begin_token = ppp.end_token = rt
                return ppp
        pits = PersonItemToken.tryAttachList(t, None, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
        if ((pits is None and (isinstance(t, TextToken)) and t.chars.is_all_lower) and t.length_char > 3): 
            pi0_ = PersonItemToken.tryAttach(t, None, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN) | (PersonItemToken.ParseAttr.CANBELOWER), PersonItemToken.ParseAttr), None)
            if (pi0_ is not None and pi0_.lastname is not None and ((pi0_.lastname.is_in_dictionary or pi0_.lastname.is_lastname_has_std_tail))): 
                pits = PersonItemToken.tryAttachList(pi0_.end_token.next0_, None, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
        ...
        if (pits is not None and prev_pers_template != FioTemplateType.UNDEFINED and pits[0].typ == PersonItemToken.ItemType.VALUE): 
            ...
            if (((isinstance(tt1, TextToken)) and tt1.chars.is_letter and tt1.chars.is_all_upper) and tt1.length_char == 1 and (tt1.whitespaces_before_count < 2)): 
                ii = PersonItemToken._new2385(tt1, tt1, PersonItemToken.ItemType.INITIAL, (Utils.asObjectOrNull(tt1, TextToken)).term, tt1.chars)
                pits.append(ii)
            if (len(pits) == 1 and pits[0].is_newline_after and ((prev_pers_template == FioTemplateType.SURNAMEI or prev_pers_template == FioTemplateType.SURNAMEII))): 
                ppp = PersonItemToken.tryAttachList(pits[0].end_token.next0_, None, PersonItemToken.ParseAttr.CANBELATIN, 10)
        ...
        if (pits is not None and len(pits) > 1): 
            ...
            if (pits[0].typ == PersonItemToken.ItemType.VALUE and pits[1].typ == PersonItemToken.ItemType.INITIAL): 
                if ((t.isValue("ГЛАВА", None) or t.isValue("СТАТЬЯ", "СТАТТЯ") or t.isValue("РАЗДЕЛ", "РОЗДІЛ")) or t.isValue("ПОДРАЗДЕЛ", "ПІДРОЗДІЛ") or t.isValue("ЧАСТЬ", "ЧАСТИНА")): 
                    return None
                if ((t.isValue("CHAPTER", None) or t.isValue("CLAUSE", None) or t.isValue("SECTION", None)) or t.isValue("SUBSECTION", None) or t.isValue("PART", None)): 
                    return None
                first = pits[1]
                last = pits[0]
            ...
            if (len(pits) == 2 and pits[0].typ == PersonItemToken.ItemType.VALUE and pits[1].typ == PersonItemToken.ItemType.VALUE): 
                if (pits[0].chars.is_latin_letter and ((not pits[0].is_in_dictionary or not pits[1].is_in_dictionary))): 
                    if (not MiscHelper.isEngArticle(pits[0].begin_token)): 
                        first = pits[0]
                        last = pits[1]
                ...
                if ((res.end_token.whitespaces_after_count < 2) and (isinstance(res.end_token.next0_, NumberToken))): 
                    ...
                    if (num.value == (2) or num.value == (3)): 
                        if (num.morph.class0_.is_adjective): 
                            pers.addSlot(PersonReferent.ATTR_NICKNAME, str(num.value), False, 0)
                            res.end_token = res.end_token.next0_
                return res
        if (pits is not None and len(pits) == 1 and pits[0].typ == PersonItemToken.ItemType.VALUE): 
            tt = pits[0].end_token.next0_
            comma = False
            if (tt is not None and ((tt.is_comma or tt.isChar('.')))): 
                tt = tt.next0_
                comma = True
            if (((isinstance(tt, TextToken)) and tt.length_char == 2 and tt.chars.is_all_upper) and tt.chars.is_cyrillic_letter): 
                ...
                pers.addSlot(PersonReferent.ATTR_FIRSTNAME, (Utils.asObjectOrNull(tt, TextToken)).term[0], False, 0)
                pers.addSlot(PersonReferent.ATTR_MIDDLENAME, (Utils.asObjectOrNull(tt, TextToken)).term[1], False, 0)
                res = ReferentToken._new2440(pers, t, tt, FioTemplateType.SURNAMEII)
                if (tt.next0_ is not None and tt.next0_.isChar('.')): 
                    tt = tt.next0_
                    res.end_token = tt
                res.data = t.kit.getAnalyzerDataByAnalyzerName(PersonAnalyzer.ANALYZER_NAME)
            ...
            if ((((((isinstance(tt, TextToken)) and (tt.whitespaces_before_count < 2) and tt.length_char == 1) and tt.chars.is_all_upper and tt.chars.is_cyrillic_letter) and (isinstance(tt.next0_, TextToken)) and (tt.whitespaces_after_count < 2)) and tt.next0_.length_char == 1 and tt.next0_.chars.is_all_upper) and tt.next0_.chars.is_cyrillic_letter): 
                pers = PersonReferent()
                pers.addSlot(PersonReferent.ATTR_LASTNAME, pits[0].value, False, 0)
                pers.addSlot(PersonReferent.ATTR_FIRSTNAME, (Utils.asObjectOrNull(tt, TextToken)).term, False, 0)
                pers.addSlot(PersonReferent.ATTR_MIDDLENAME, (Utils.asObjectOrNull(tt.next0_, TextToken)).term, False, 0)
                res = ReferentToken._new2440(pers, t, tt.next0_, FioTemplateType.SURNAMEII)
                if (tt.next0_.next0_ is not None and tt.next0_.next0_.isChar('.')): 
                    res.end_token = tt.next0_.next0_
                res.data = t.kit.getAnalyzerDataByAnalyzerName(PersonAnalyzer.ANALYZER_NAME)
                return res
            if (comma and tt is not None and (tt.whitespaces_before_count < 2)): 
                pits1 = PersonItemToken.tryAttachList(tt, None, Utils.valToEnum((PersonItemToken.ParseAttr.CANINITIALBEDIGIT) | (PersonItemToken.ParseAttr.CANBELATIN), PersonItemToken.ParseAttr), 10)
                if (pits1 is not None and len(pits1) > 0 and pits1[0].typ == PersonItemToken.ItemType.INITIAL): 
                    ...
                    res = ReferentToken._new2440(pers, t, pits1[0].end_token, FioTemplateType.SURNAMEI)
    ...
    @staticmethod
    def _new2383(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'PersonItemToken':
    ...
    @staticmethod
    def _new2385(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'CharsInfo') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.chars = _arg5
    ...
    @staticmethod
    def _new2391(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'PersonReferent', _arg5 : 'MorphCollection') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.referent = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new2399(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'CharsInfo') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        res.chars = _arg4
        return res
    ...
    @staticmethod
    def _new2414(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        return res
    
    @staticmethod
    def _new2415(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'CharsInfo', _arg5 : 'MorphCollection') -> 'PersonItemToken':
        res = PersonItemToken(_arg1, _arg2)
        res.value = _arg3
        res.chars = _arg4
        res.morph = _arg5
